var Shaders = {
    ...
    'csg-intersect':
        ...
        '    ), matId, isect);\n'                                                           +
        '}\n'                                                                               +
        'void biconvexLensIntersectH(Ray ray, vec2 center, float h, float d, float r1, fl'  +
                                    'oat r2, float matId, inout Intersection isect) {\n'    +
        '    segmentCollapse(segmentIntersection(segmentIntersection(\n'                    +
        '        vertSpanIntersect(ray, center.y, h),\n'                                    +
        '        sphereSegmentIntersect(ray, center + vec2(0.0, r1 - d), r1)),\n'           +
        '        sphereSegmentIntersect(ray, center - vec2(0.0, r2 - d), r2)\n'             +
        '    ), matId, isect);\n'                                                           +
        '}\n'                                                                               +
